...
@Database(entities = [MembersEntity::class, CarsEntity::class, DuesEntity::class, FinancesEntity::class,
    ...
    companion object{
        ...
        fun getInstance(context: Context): com.rafalropel.mobileosp.Database {
            ...
            synchronized(this){
                ...
                if(instance == null){
                    instance = Room.databaseBuilder(context.applicationContext, com.rafalropel.mobileosp.Database::class.java,
                    "mobileosp_database").fallbackToDestructiveMigration()
                        .build()
